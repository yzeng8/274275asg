...
class TrainingSet(C274):
    ...
    ###newly add to support new requirement of copy()
    ...
    def preprocess(self, mode=''):
        '''
        use preprocess_words(mode'') in class TrainingInstance to perform preprocessing for all training instances in a particular training dataset.
        '''
